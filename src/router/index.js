  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: '/footprints',
          name: 'footprints',
          component: (resolve) => require(['@/pages/butler'], resolve)
        },
        {
          path: '/day',
          name: 'day',
    ...
    },
    {
      path: '/Goods/Detail',
      name: 'Detail',
      component: (resolve) => require(['@/pages/index/childPage/goodDetail'], resolve)
    },
    {
      path: '/my/order',
      name: 'order',
      component: (resolve) => require(['@/pages/my/childPage/order'], resolve)
    }
  ]
})
